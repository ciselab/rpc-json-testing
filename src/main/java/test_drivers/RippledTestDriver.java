...
//        processBuilder.command("kill", "$(lsof -t -i:5005)");
//        processBuilder.command("sleep", "5");
        processBuilder.command("cd", "rippled-1.6.0/build/cmake/coverage");
        processBuilder.command("./rippled", "-a", "-v", "--debug", "&", "disown");
//        processBuilder.command("sleep", "5");
