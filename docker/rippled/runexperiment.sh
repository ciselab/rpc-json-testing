...
docker run -it --name rippled_tool_container_$3_$1_$2 rippled_tool:V1.0.0 $1 $2 $3
...
mkdir exp_$3_$1_$2
docker cp rippled_tool_container_$3_$1_$2:/rippled-1.6.0/coverage_results_without_archive.txt ./exp_$3_$1_$2/
docker cp rippled_tool_container_$3_$1_$2:/rippled-1.6.0/coverage_results.txt ./exp_$3_$1_$2/
