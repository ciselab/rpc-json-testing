...
echo "Server: " $4", heuristic:" $1 ", population: " $5 ", mutation proportion: " $6 ", type change probability: " $7 " and budget:" $2 " " $3 ", clustering after gens: " $8 >> final_coverage_total.txt cat final_coverage_total.txt
...
##echo "Server: " $4", heuristic:" $1 ", population: " $5 ", mutation proportion: " $6 ", type change probability: " $7 " and budget:" $2 " " $3 ", clustering after gens: " $8 >> final_coverage_archive.txt cat final_coverage_archive.txt
