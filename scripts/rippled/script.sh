...
echo "These results are based on server: " $3", fitness function:" $1 ", mutation proportion: " $4 " and time:" $2 "minutes." >> final_bcoverage_total.txt cat final_bcoverage_total.txt
gcovr -s -r ./ -f 'src/ripple' -o final_lcoverage_total.txt
echo "These results are based on server: " $3", fitness function:" $1 ", mutation proportion: " $4 " and time:" $2 "minutes." >> final_lcoverage_total.txt cat final_lcoverage_total.txt
...
echo "These archive tests were based on server: " $3", fitness function:" $1 ", mutation proportion: " $4 " and time:" $2 "minutes." >> final_bcoverage_archive.txt cat final_bcoverage_archive.txt
gcovr -s -r ./ -f 'src/ripple' -o final_lcoverage_archive.txt
echo "These archive tests were based on server: " $3", fitness function:" $1 ", mutation proportion: " $4 " and time:" $2 "minutes." >> final_lcoverage_archive.txt cat final_lcoverage_archive.txt
